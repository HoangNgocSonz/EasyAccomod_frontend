  ...
  render() {
    return (
      <div className="adminss">
        <Navbar></Navbar>
        <div className="row container" id="dowdow">
              ...
              <ul className="nav navbar-nav navbar_mg-ul">
                <div>
                  ...
                  <li className="nav-link post_manager-memu">
                    <Link
                      to="/admin/quan-li-nha-tro"
                      className="nav-link nav_menu_mg"
                    >
                      <span>Danh sách trọ cho thuê</span>
                    </Link>
                  </li>
                  <li className="nav-link post_manager-memu">
                    <Link
                      ...
                      className="nav-link nav_menu_mg"
                    >
                      <span>Danh sách chủ trọ</span>
                    </Link>
                  </li>
                  <li className="nav-link post_manager-memu">
                    <Link
                      to="/admin/danh-sach-bai-dang"
                      className="nav-link nav_menu_mg"
                    >
                  ...
                  <li className="nav-link post_manager-memu">
                    <Link to="/admin/thong-ke" className="nav-link nav_menu_mg">
                      <span>Thống kê</span>
                    </Link>
                  </li>
                  <li className="nav-link post_manager-memu">
                    <Link
                      to="/admin/xem-trang-chu"
                      className="nav-link nav_menu_mg"
                    >
          ...
          <div className="col-md-10 col-sm-10">
            <Switch>
              ...
              <Route
                exact
                path="/admin/danh-sach-bai-dang"
                component={ManagePost}
              />
              <Route
                exact
                path="/admin/danh-sach-phan-hoi"
                component={AcceptComment}
              />
            </Switch>
          </div>
        </div>
