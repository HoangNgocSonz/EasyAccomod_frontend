        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="form-check mb-4">
              {" "}
              <input name="feedback" type="radio" ref="veryGood" value={this.state.feedback}  onChange={this.handleInputChange}/>{" "}
              <label className="ml-3">Rất tốt</label>{" "}
            </div>
            <div className="form-check mb-4">
              {" "}
              <input name="feedback" type="radio" ref="Good" value={this.state.feedback} onChange={this.handleInputChange}/>{" "}
              <label className="ml-3">Tốt</label>{" "}
            </div>
            <div className="form-check mb-4">
              {" "}
              <input name="feedback" type="radio" ref="normal" value={this.state.feedback}  onChange={this.handleInputChange}/>{" "}
              <label className="ml-3">Bình thường</label>{" "}
            </div>
            <div className="form-check mb-4">
              {" "}
              <input name="feedback" type="radio" ref="Bad" value={this.state.feedback} onChange={this.handleInputChange}/>{" "}
              <label className="ml-3">Tệ</label>{" "}
            </div>
            <div className="form-check mb-4">
              {" "}
              <input name="feedback" type="radio" ref="veryBad" value={this.state.feedback}  onChange={this.handleInputChange}/>{" "}
